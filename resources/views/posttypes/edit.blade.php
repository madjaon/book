      ...
      <div class="col-sm-12">
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <strong>Editing Post Type: </strong>
            <a href="{{ url($data->slug) }}" target="_blank">{{ str_limit($data->name, 30) }}</a>

            <a href="/posttypes" class="btn btn-info btn-xs pull-right">
          ...
          {!! Form::model($data, array('action' => array('PostTypesController@update', $data->id), 'method' => 'PUT')) !!}
