...
<script type="text/javascript">
	$(function () {
		// append will no load fancybox. this to fix it.
		$("#ul_images").on("focusin", function(){
			$(".fancybox").fancybox({"width":"100%","height":"auto","type":"iframe","autoScale":false});
		}); // on
		$(".fancybox").fancybox({"width":"100%","height":"auto","type":"iframe","autoScale":false});
		tiny_mce();
		tinyMCE.get('textarea.elm').setContent(tinyMCE.get('textarea.elm').getContent()+_newdata);
		tinyMCE.triggerSave();
	});
	function tiny_mce()
	{
	...
	//        language: 'vi',
	        plugins: [
	             ...
	             "save table contextmenu directionality emoticons template paste textcolor"
					...
					content_css: "/plugins/tinymce/skins/lightgray/content.min.css",
	...
	function GetFilenameFromPath(id, thumb='')
	{
	    var filePath = $('#'+id).val();
