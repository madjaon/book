...
<ol class="breadcrumb px-0 py-2" itemscope itemtype="http://schema.org/BreadcrumbList">
  <li class="breadcrumb-item" itemprop="itemListElement" itemscope
      itemtype="http://schema.org/ListItem"><a href="{{ url('/') }}" title="{{ trans('caption.homepage') }}" itemprop="item"><span itemprop="name">{{ trans('caption.homepage') }}</span></a><meta itemprop="position" content="1" /></li>
