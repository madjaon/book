...
class ProfilesController extends Controller
{
    ...
    public function upload()
    {
        if (Input::hasFile('file')) {
            ...
            // or: storage_path().'/app/public/users/'...
            $save_path = public_path().'/storage/users/'.$currentUser->id.'/';
            $path = $save_path.$filename;
            $public_path = '/storage/users/'.$currentUser->id.'/'.$filename;
    ...
    /**
     * Show user avatar.// upload vao storage/app/public/users/... symlink public folder
     * Neu da co symlink o thu muc public thi khong su dung function nay
     *
     * @param $id
     * @param $image
     *
    ...
    {
        return Image::make(storage_path().'/app/public/users/'.$id.'/'.$image)->response();
    }
